...
module HELLOWORLD_mm_interconnect_0 (
	...
	wire  [90:0] rsp_mux_src_data;                                                            // rsp_mux:src_data -> cpu_0_data_master_agent:rp_data
	...
	wire  [90:0] rsp_mux_001_src_data;                                                        // rsp_mux_001:src_data -> cpu_0_instruction_master_agent:rp_data
	...
	wire  [91:0] cpu_0_debug_mem_slave_agent_rf_source_data;                                  // cpu_0_debug_mem_slave_agent:rf_source_data -> cpu_0_debug_mem_slave_agent_rsp_fifo:in_data
	...
	wire  [91:0] cpu_0_debug_mem_slave_agent_rsp_fifo_out_data;                               // cpu_0_debug_mem_slave_agent_rsp_fifo:out_data -> cpu_0_debug_mem_slave_agent:rf_sink_data
	...
	wire  [90:0] cmd_mux_001_src_data;                                                        // cmd_mux_001:src_data -> cpu_0_debug_mem_slave_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                       // cpu_0_debug_mem_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [2:0] cmd_mux_001_src_channel;                                                     // cmd_mux_001:src_channel -> cpu_0_debug_mem_slave_agent:cp_channel
	...
	wire  [90:0] cpu_0_data_master_agent_cp_data;                                             // cpu_0_data_master_agent:cp_data -> router:sink_data
	...
	wire  [90:0] cpu_0_instruction_master_agent_cp_data;                                      // cpu_0_instruction_master_agent:cp_data -> router_001:sink_data
	...
	wire  [90:0] cpu_0_debug_mem_slave_agent_rp_data;                                         // cpu_0_debug_mem_slave_agent:rp_data -> router_003:sink_data
	...
	HELLOWORLD_mm_interconnect_0_router router_001 (
	...
	HELLOWORLD_mm_interconnect_0_router_002 router_003 (
	...
	HELLOWORLD_mm_interconnect_0_router_002 router_004 (
	...
	HELLOWORLD_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (cpu_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	HELLOWORLD_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (cpu_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	HELLOWORLD_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (cpu_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	HELLOWORLD_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (cpu_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	HELLOWORLD_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (cpu_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	HELLOWORLD_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (cpu_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
