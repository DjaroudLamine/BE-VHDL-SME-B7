...
module Bp_Led_mm_interconnect_0 (
	...
	wire         cmd_mux_002_src_valid;                                                     // cmd_mux_002:src_valid -> Bp_s1_agent:cp_valid
	wire  [92:0] cmd_mux_002_src_data;                                                      // cmd_mux_002:src_data -> Bp_s1_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                     // Bp_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [4:0] cmd_mux_002_src_channel;                                                   // cmd_mux_002:src_channel -> Bp_s1_agent:cp_channel
	wire         cmd_mux_002_src_startofpacket;                                             // cmd_mux_002:src_startofpacket -> Bp_s1_agent:cp_startofpacket
	wire         cmd_mux_002_src_endofpacket;                                               // cmd_mux_002:src_endofpacket -> Bp_s1_agent:cp_endofpacket
	...
	wire         bp_s1_agent_rp_valid;                                                      // Bp_s1_agent:rp_valid -> router_004:sink_valid
	wire  [92:0] bp_s1_agent_rp_data;                                                       // Bp_s1_agent:rp_data -> router_004:sink_data
	wire         bp_s1_agent_rp_ready;                                                      // router_004:sink_ready -> Bp_s1_agent:rp_ready
	wire         bp_s1_agent_rp_startofpacket;                                              // Bp_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire         bp_s1_agent_rp_endofpacket;                                                // Bp_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire         bp_s1_agent_rdata_fifo_src_valid;                                          // Bp_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire  [33:0] bp_s1_agent_rdata_fifo_src_data;                                           // Bp_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire         bp_s1_agent_rdata_fifo_src_ready;                                          // avalon_st_adapter_002:in_0_ready -> Bp_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_002_out_0_valid;                                         // avalon_st_adapter_002:out_0_valid -> Bp_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_002_out_0_data;                                          // avalon_st_adapter_002:out_0_data -> Bp_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_002_out_0_ready;                                         // Bp_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire   [0:0] avalon_st_adapter_002_out_0_error;                                         // avalon_st_adapter_002:out_0_error -> Bp_s1_agent:rdata_fifo_sink_error
	...
	Bp_Led_mm_interconnect_0_router_004 router_004 (
	...
	Bp_Led_mm_interconnect_0_router_002 router_005 (
	...
	Bp_Led_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Bp_Led_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Bp_Led_mm_interconnect_0_rsp_demux_002 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Bp_Led_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
